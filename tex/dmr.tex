...
Since the estimated loadings $\bs{\phi}_k$ are partial effects, controlling for the influence of other attributes, the SR projections will also correspond to partial rather than marginal association.
...
can also, as in
\cite{taddy_multinomial_2013}, normalize by length and work with $\bm{z}/m$.
